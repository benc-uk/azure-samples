...
#docker run --rm -p 5000:5000 containerpreview.azurecr.io/microsoft/cognitive-services-text-to-speech:latest EULA=accept BILLING=https://$API_REGION.api.cognitive.microsoft.com APIKEY=$API_KEY
